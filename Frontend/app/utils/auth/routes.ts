...
export const routePermissionMap: RoutePermissionEntry[] = [
  ...
  { home: '/reward', match: (path) => path.startsWith('/reward'), permission: PERMISSIONS.productView },
  ...
  { home: '/history', match: (path) => path.startsWith('/history'), permission: PERMISSIONS.historyView, roles: ['admin'] },
