...
export const RBAC_ALIASES: Record<string, readonly string[]> = {
  ...
  'reward:view': ['settings:reward-management:view', 'settings:product-management:view'],
  'reward:create': ['settings:reward-management:create', 'settings:product-management:create'],
  'reward:update': ['settings:reward-management:update', 'settings:product-management:update'],
  'reward:delete': ['settings:reward-management:delete', 'settings:product-management:delete'],
