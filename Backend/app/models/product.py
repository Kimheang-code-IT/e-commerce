...
class Product(Base):
    ...
    discount_price: Mapped[float] = mapped_column(Float, default=0)
    total_price: Mapped[float] = mapped_column(Float, default=0)
    size: Mapped[str] = mapped_column(String(120), default="")
    top: Mapped[str] = mapped_column(String(120), default="")
    back_side: Mapped[str] = mapped_column(String(120), default="")
    fretboard: Mapped[str] = mapped_column(String(180), default="")
    string_brand: Mapped[str] = mapped_column(String(120), default="")
    finishing: Mapped[str] = mapped_column(String(120), default="")
